Welcome, here you will find all the instrucions necessary to run the Cypress automation project.
...
03- Open terminal, Go to "CHALLENGE-QA-RAIDIAM" folder and run the following commands:
    a- npm init --yes
